...
import "@/styles/walmart-font.css";
...
export default function DeceptionPage() {
  ...
  return (
    <div className="walmart-ui min-h-screen bg-gray-50">
      <WalmartHeader
        onSignIn={handleSignIn}
        onCreateAccount={handleCreateAccount}
        onBackToHome={handleBackToHome}
        onViewCart={() => setCurrentView('cart')}
        onViewMyItems={() => setCurrentView('myitems')}
        onReorder={() => setCurrentView('reorder')}
        isSignedIn={isSignedIn}
        cartCount={cartItems.length}
        cartTotal={cartTotal}
      />
      <main className="walmart-main max-w-7xl mx-auto py-8 px-4">
        {currentView === 'signin' && (
          <div className="py-12">
            <FakeLogin />
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-walmart-blue to-walmart-dark-blue text-white py-8">
              <div className="max-w-7xl mx-auto px-4 text-center">
                <h1 className="text-4xl font-bold mb-4 text-black">Black Friday Deals are Here!</h1>
                <p className="text-xl mb-6 text-black">Save big on everything you love</p>
                <button 
